function f = non_linear_w_PI(t, y, U, T_0, T_sp, k_c, tau_I)
    ...
    f(3) = 5.76581153162306e+15*C_A*(C_A + 0.8)*exp(-15395.7180659129/T) + 1.01600203200406e+86*C_S*exp(-96223.2379119557/T) - 0.0625*T + 0.0625*T_0 - 4.20688341376683e-7*U_in*(T - 373);
    f(4) = e;